        ...
        http:
          routers:
            my-router:
              ...
              # (optionally) List here the middlewares to which the request will be forwarded when the route is activated
              middlewares:
                - "authentication"
                - "my-local-middleware"
          ...
          # define here the service's urls where the request will be forwarded
          services:
            my-service:
              loadBalancer:
                servers:
