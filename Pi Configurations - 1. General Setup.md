...
### Create a site
1. Create the web folder in the `/var/www/html/` folder

3. Create the configuration file in the `/etc/nginx/sites-available/` 
...
5. Enable the site, linking the configuration file 
