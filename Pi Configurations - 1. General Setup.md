...
💡 For the built from source version, the `torrc` file should be located into the `/usr/local/etc/tor/` folder. You can check it running `tor`. One the first lines of the output should tell the exact location where the executable 
### obfs4proxy
