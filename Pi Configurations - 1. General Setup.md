...
So, when your client tries to connect (i.e. send a packet) to a IP address of your LAN, that packet will be routed through the wireguard tunnel and sent to the  
## Install Pi-hole
