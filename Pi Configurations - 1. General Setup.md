...
- [General Setup](#general-setup)
  ...
  - [Traefik](#traefik)
    ...
    - [Setup Traefik as systemd service](#setup-traefik-as-systemd-service)
...
2. Create the file `/etc/traefik/traefik.yml` with the following content:
    ...
    ⚠️ Don't forget to edit the `<YOUR_EMAIL>`
    
    💡 For the first runs you may want to set the log level to `DEBUG` to troubleshoot errors
...
- Add new [Middlewares](https://doc.traefik.io/traefik/middlewares/overview/) 
 ...
 - To add a new Service
    ...
    2. Configure into this file the Service's [Router](https://doc.traefik.io/traefik/routing/routers/) and [Service](https://doc.traefik.io/traefik/routing/services/) (and, eventually, local Middlewares). 
        ...
        See `/etc/traefik/dynamic/dashboard.yml` and the following template as references
