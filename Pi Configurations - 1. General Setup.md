...
4. Create the client's `.conf` file
   ...
   ⚠️ Make sure to give an unique IP address for any further client! We add the first client with the IP addresses 10.100.0.2 and fd08:4711::2/128 in this example (10.100.0.1 and fd08:4711::1/128 are the server)
