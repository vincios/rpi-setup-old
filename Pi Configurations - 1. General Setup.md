...
Basically, for each computer (peer) we have to configure an interface, with an IP address, a private key and a listening port. Then we have to list all the peers we wants to connect. This configuration 

See this [guide](https://www.stavros.io/posts/how-to-configure-wireguard/) for details setup example. 
