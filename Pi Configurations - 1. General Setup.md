...
- Default Samba share of the user folder have some security restrictions. So, in the `[homes]` section of *smb.conf* find the line `read only = no` and change to `read only = 
- Add to bottom:
