...
- Default Samba share of the user folder have some security restrictions. So, in the `[homes]` section of *smb.conf* find the line `read only = yes` and change to `read only = no`
