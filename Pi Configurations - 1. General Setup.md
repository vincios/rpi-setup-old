...
```bash
$ sudo sed -i '/^AllowedIPs =/ s/$/, 192.168.1.0\/24/' CLIENTS_CONF_FILE_PATH
```
...
>💡 Instead of editing your existing configuration, you can easily add a new one with the modified AllowedIPs line as above. This will give you two tunnel variants and you decide - at any time from mobile - which variant you want. 
