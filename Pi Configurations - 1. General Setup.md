...
NOTES:
- The file is configured to automatic renew Let's Encrypt TLS certificates, with a `duckdns` domain and a `dnsC. See the [official](https://doc.traefik.io/traefik/https/acme/#the-different-acme-challenges) documentation.
