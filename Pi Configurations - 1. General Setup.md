...
#### 0. Setup the configuration environment
...
#### 1. Create the client's `.conf` file
...
```ini
[Interface]
Address = 10.100.0.[X]/32, fd08:4711::[X]/128, 192.168.1.0/24
DNS = 10.100.0.1
...
#### 2. Add the new client to the server's `.conf` file
...
#### 3. Connect your client and test the connection
