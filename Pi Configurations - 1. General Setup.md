...
So, when your client tries to send a packet to an IP address of your LAN, that packet will be intercepted and routed through the wireguard tunnel and sent to the server (even outside the LAN). 
## Install Pi-hole
