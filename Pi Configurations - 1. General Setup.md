...
We use file provider to manually set the dynamic configuration (Routers, Services and Middlewares) for each service we want to be served by Traefik proxy.
### Setup Service
