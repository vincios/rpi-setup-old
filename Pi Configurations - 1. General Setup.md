...
Simply edit the client's `.conf` file (**NOT the server's one**) and add the default route (`0.0.0.0/0` for IPv4 and `::/0` for IPv6) to `AllowedIPs` in the [Peer] section of your clients's WireGuard config files:
