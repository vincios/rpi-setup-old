...
> - `nft add table ip wireguard; ...`: This rule configures masquerading, i.e. rewrites IPv4 traffic that comes in on the wireguard `wg0` VPN interface to make it appear like it originates directly from the WireGuard Server’s public IPv4 address
