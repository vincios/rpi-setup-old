...
2. Create the file `/etc/traefik/dynamic/dashboard.yml`, with the following content
  ...
  3. Set your duckdns token in a `DUCKDNS_TOKEN` environment variable. If you have configured the [duckdns cron](#duckdns-cron-configuration), the environment variable should be already set.
### Setup Service
