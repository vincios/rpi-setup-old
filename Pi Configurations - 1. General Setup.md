...
We will use the Wireguard `PostUp` and `PreDown` configuration settings to enable the NAT rules when the . The `PostUp` lines will run when the WireGuard Server starts 
