...
### Create a site
1. Create the web folder in the `/var/www/html/
1. Create the configuration file in the `/etc/nginx/sites-available/` 
...
3. Enable the site, linking the configuration file 
