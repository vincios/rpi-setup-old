...
NOTES:
- The file is configured to automatic renew Let's Encrypt ACME certificates, with a `duckdns` domain and a `dns. See the [official](https://doc.traefik.io/traefik/https/acme/#the-different-acme-challenges) documentation.
