...
In our setup, we have a server peer (the pi) to which all client peers (the other devices) connect. We will follow the official Pi-hole Wireguard setup [guide](https://docs.pi-hole.net/guides/vpn/wireguard/server/).
## Install Pi-hole
