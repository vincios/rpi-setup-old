...
2. [Install Pi-hole](https://docs.pi-hole.net/main/basic-install/)
    ...
    ⚠️ If you want to use [nginx](#ngnix-and-php) as web server for the web inteface, during the installation wizard, install the web interface éwithout** the default `lighttpd` web server 
    ```bash
...
2. [Change the lighttpd port](#change-the-lighttpd-port)
