...
You can now copy the configuration file to your client. If the client is a mobile device such as a phone, qrencode can be used to generate a scanable QR code:
