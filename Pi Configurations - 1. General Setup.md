...
1. Create the file `/etc/logrotate.d/traefik` (with `sudo`) and paste this content
    ...
    💡 This configuration will daily compress the logs files, keeping the last 7 days logs and deleting the oldest ones. See the [logrotate](https://guide.debianizzati.org/index.php/Logrotate:_configurare_la_rotazione_automatica_dei_log)
