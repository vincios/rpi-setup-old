...
- [1. General Setup](#1-general-setup)
  - [1.1. First operations](#11-first-operations)
  - [1.2. VNC "cannot currently show the desktop" in headless mode](#12-vnc-cannot-currently-show-the-desktop-in-headless-mode)
  - [1.3. AutoMount Nas folders](#13-automount-nas-folders)
  - [1.4. Samba shares](#14-samba-shares)
  - [1.5. Duckdns cron configuration](#15-duckdns-cron-configuration)
  - [1.6. Plex Media Server](#16-plex-media-server)
  - [1.7. Build TOR](#17-build-tor)
  - [1.8. Run BridTools](#18-run-bridtools)
  - [1.9. Install jDownloader in headless mode](#19-install-jdownloader-in-headless-mode)
  - [1.10. JDownloader RAR5 support](#110-jdownloader-rar5-support)
  - [1.11. Update Node and npm](#111-update-node-and-npm)
  - [1.12. Install Deluge torrent client with web interface](#112-install-deluge-torrent-client-with-web-interface)
  - [1.13. Install Transmission](#113-install-transmission)
  - [1.14. Install LAMP software](#114-install-lamp-software)
    - [1.14.1. Add xdebug](#1141-add-xdebug)
    - [1.14.2. Start, Stop and Restart apache2 service](#1142-start-stop-and-restart-apache2-service)
  - [1.15. Install Ampache](#115-install-ampache)
  - [1.16. Deemix](#116-deemix)
    - [1.16.1. Notes](#1161-notes)
  - [1.17. Install Python 3](#117-install-python-3)
  - [1.18. Install Pi-hole](#118-install-pi-hole)
- [2. Home Assistant](#2-home-assistant)
  - [2.1. Install HA](#21-install-ha)
  - [2.2. Service creation](#22-service-creation)
  - [2.3. Install/Uninstall Rust](#23-installuninstall-rust)
    - [2.3.1. Disclaimer](#231-disclaimer)
    - [2.3.2. Install Rust](#232-install-rust)
    - [2.3.3. Uninstall Rust](#233-uninstall-rust)
  - [2.4. Switch to homeassistant user](#24-switch-to-homeassistant-user)
  - [2.5. Updating](#25-updating)
    - [2.5.1. Application](#251-application)
    - [2.5.2. Virtual Envrionment](#252-virtual-envrionment)
  - [2.6. Activate Advanced Mode](#26-activate-advanced-mode)
  - [2.7. Edit configuration.yaml file](#27-edit-configurationyaml-file)
  - [2.8. Create ssl certificate](#28-create-ssl-certificate)
  - [2.9. Install HACS](#29-install-hacs)
  - [2.10. Mosquitto installation and configuration](#210-mosquitto-installation-and-configuration)
  - [2.11. Enable Alexa integration](#211-enable-alexa-integration)
  - [2.12. Enable Google Home integration](#212-enable-google-home-integration)
  - [2.13. Create a reload integration rest command](#213-create-a-reload-integration-rest-command)
  - [2.14. Other useful commands](#214-other-useful-commands)
  - [2.15. Troubleshooting](#215-troubleshooting)
    - [2.15.1. "GLIBC\_2.29" not found](#2151-glibc_229-not-found)
    - [2.15.2. Manual start with `hass -v` (or `hass`) crash without errors](#2152-manual-start-with-hass--v-or-hass-crash-without-errors)
    - [2.15.3. HA Core - Version xx.xx.xx of SQLite is not supported](#2153-ha-core---version-xxxxxx-of-sqlite-is-not-supported)
- [3. Useful commands](#3-useful-commands)
  - [3.1. List active processes](#31-list-active-processes)
- [4. .bash\_aliases](#4-bash_aliases)

## 1.1. First operations
...
## 1.2. VNC "cannot currently show the desktop" in headless mode
Run `raspi-config` and change screen resolution to 1920x1080

## 1.3. AutoMount Nas folders
...
## 1.5. Duckdns cron configuration
...
## 1.9. Install jDownloader in headless mode
...
## 1.12. Install Deluge torrent client with web interface
...
### 1.14.2. Start, Stop and Restart apache2 service
```
## Start command ##
...
## 2.4. Switch to homeassistant user
...
## 2.10. Mosquitto installation and configuration
- Install Mosquitto
...
## 2.12. Enable Google Home integration
...
### 2.15.2. Manual start with `hass -v` (or `hass`) crash without errors
...
### 2.15.3. HA Core - Version xx.xx.xx of SQLite is not supported
